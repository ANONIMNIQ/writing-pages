            ...
            <div className="mb-12 lg:mb-20 group">
              ...
              <div className="flex items-start space-x-4">
                ...
                <input 
                  ...
                  className="bg-transparent border-none text-2xl md:text-4xl font-serif font-light italic tracking-tight placeholder:text-foreground/10 focus:outline-none w-full py-0"
                  value={quickTitle}
